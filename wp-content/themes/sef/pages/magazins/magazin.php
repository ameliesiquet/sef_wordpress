<div>
    <section class="magazins__magazin1 showUp">
        ...
        if ($maison_1):
            ...
            <article class="magazins__magazin1__article">
                <div class="house-magazine">
                    ...
                    <p class="house-magazine__content"><?php echo get_field('magazin_second_title', $maison_1->ID); ?>
    ...
    <section class="magazins__magazin2 showUp">
        ...
        if ($maison_2): ?>
            <article class="magazins__magazin2__article">
                <div class="house-magazine">
                    ...
                    <p class="house-magazine__content"><?php echo get_field('magazin_second_title', $maison_2->ID); ?>
